...
function check2(){
    ...
    while(true/false){
        ...
        //true일 때 반복 수행하는 코드
        console.log("i :", i++);//ㅑ에1씩 더해서 출력
        if(i>10)break;//10초과 시 멈춤
    }
}
...
/* 1부터 30까지 1씩 증가하며 출력 단, 홀 수 또는 10의 배수 건너뛰기 */
function check4(){
...
function check5(){
    for(let row=1; row<=5; row++){
       ...
       console.log(str);//한줄을 출력하는 구문
        
       /* 출력하고 나서 3번째에서 멈추기 때문에 console 아래에 써야함 */
       if(row == 3) break;
    }
