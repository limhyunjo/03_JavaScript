...
//btn2a가 클릭 되었을 때 arrayTest() 함수 호출
document.querySelector("#btn2a").addEventListener("click", function(){
 ...
 // arrayTest() 함수에서 arr와 같은 배열을 참조해서 수정
 //-> 함수 수행 후 돌아와서도
...
//;는 한줄이 끝났다는 의미 
//자바스크립트에서는 자동으로 한줄만 읽지만 나중에 코드를 
//간소화 할때 쓰여서 사용하는게 좋음
//------------------------------------------
