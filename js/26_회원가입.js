...
signupForm.addEventListener("submit", e=>{
    ...
    for(let key in checkList){
     ...
     // console.log("key : ", key); 객체가 가진 key와 value를 다룰 수 있음
...
/* 객체 전용(객체에서만 씀) 향상된 for문 : for ~ in 구문
